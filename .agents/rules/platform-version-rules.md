...
- Laravel 13 hỗ trợ PHP 8.3 - 8.5; chỉ dùng PHP 8.4 hoặc 8.3 khi package, runtime, hoặc hosting bắt buộc và phải ghi lý do vào `.agents/context/decisions.md`.

## Composer và Dependency

- Source Laravel của ứng dụng phải nằm trong thư mục riêng `video-generator-app/` ở root repo, trừ khi `.agents/context/project-context.md` được cập nhật sang tên thư mục khác.
