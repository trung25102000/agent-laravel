...
- Với Laravel 13, không giả định `routes/api.php` luôn tồn tại trong skeleton mới. Nếu cần API routes, bật hoặc tạo theo cơ chế chính thức và ghi lại vào `.agents/context/routes-map.md`.
