...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="@yield('meta_description', 'AI Video Generator tạo video dọc 9:16 từ ý tưởng, script, scene, voice, subtitle và FFmpeg render.')">
            ...
            <header class="border-b border-teal-100 bg-white/95">
                <div class="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
                    <a href="{{ auth()->check() ? route('dashboard') : url('/') }}" class="flex items-center gap-3">
                        ...
                        <span>
                            <span class="block text-sm font-semibold text-zinc-950">{{ config('app.name', 'AI Video Generator') }}</span>
